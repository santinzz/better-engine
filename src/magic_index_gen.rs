...
mod tests {
    ...
    use crate::{magic_index_gen::{make_table, write_magics, write_table}, magics::{BISHOP_MAGICS, ROOK_MAGICS, BISHOP_TABLE_SIZE, ROOK_TABLE_SIZE}};
    ...
    fn test_magic_index() {
        ...
        std::env::set_var("OUT_DIR", "./src/constants");
